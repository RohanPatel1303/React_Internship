...
const Form = ({ navigation }) => {
   ...
   const empty=()=>{
    ...
    const functiontonavigate=()=>{
        ...
        navigation.navigate("Datastorage",{list});
    }
    const additemtolist = async () => {
        try {
            list.push({name,lastname,email,toggleCheckBox,toggleCheckBox1,toggleforupdates});
        } catch (err) {
            console.log(err);
            ...
            <View style={[styles.border, styles.rounded]}>
                ...
                <View style={[styles.inputs]}>
                    ...
                    <View style={styles.inp_title_block}>
                        ...
                        <TextInput keyboardType="default" placeholder="Lastname" style={[styles.input]} defaultValue={lastname} onChangeText={newtext => setlastname(newtext)} ></TextInput>


                    </View>
                    <View style={styles.inp_title_block}>

                        <TextInput keyboardType="email-address" placeholder="Email" style={[styles.input]} defaultValue={email} onChangeText={newtext => setemail(newtext)} ></TextInput>
                    ...
                    <View style={{ marginTop: 30, width: "100%", marginRight: 4, marginLeft: 4, alignItems: "center" }}>
                        ...
                        <View>
                            ...
                            <TouchableOpacity style={[styles.button]} onPress={() => { functiontonavigate(); additemtolist(),empty() }}>
